          ...
          toast.custom(
            (t) => (
              <button
                ...
                onClick={() => {
                  toast.dismiss(t.id);
                  navigate('/client-portal/messages');
                }}
              >
                <span className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-indigo-600 text-lg text-white">💬</span>
                <span className="min-w-0 flex-1">
                  <span className="block text-xs font-black uppercase tracking-widest text-indigo-600">Messages</span>
